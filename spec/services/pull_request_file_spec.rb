...
describe PullRequestFile do
  let(:file_hash) do
    {
      'sha' => '1f1d11010bcd1afb69f6aab2c0c0c722136e0157',
      'filename' => 'app/models/author.rb', 'status' => 'added',
  ...
  let(:contents_hash) do
    {
      'name' => 'author.rb', 'path' => 'app/models/author.rb',
      'sha' => '1f1d11010bcd1afb69f6aab2c0c0c722136e0157', 'size' => 269,
  ...
  let(:expected_reek_output) do
    [
      ...
      {
        'context' => 'Author', 'lines' => [9, 8, 7, 6, 5],
        'message' => 'tests true at least 5 times',
        'smell_category' => 'SimulatedPolymorphism',
        'smell_type' => 'RepeatedConditional',
        'source' => '/Users/craigsheen/development/other/olfaction/tmp/craigsheen/test-repo/5/author.rb20160120-23525-1ceu0qm.rb',
        'name' => 'true', 'count' => 5,
        'wiki_link' => 'https://github.com/troessner/reek/blob/master/docs/Repeated-Conditional.md'
      },
      {
        'context' => 'Author#a', 'lines' => [4], 'message' => "has the name 'a'",
  ...
  before do
    PullRequestFile.any_instance.should_receive(:contents_hash).at_least(1)
                   .and_return(contents_hash)
  end
